...
//        var password = "ImMrMeeseeks"
        ...
        if (email == "") {
            self.displayAlert(title: "Error", message: "Email must not be empty")
        } else if (password == "") {
            self.displayAlert(title: "Error", message: "Password must not be empty")
        }
...
//        var password = "ImMrMeeseeks"
        ...
        if (name == "") {
            self.displayAlert(title: "Error", message: "Name must not be empty")
        } else if (number == "") {
            self.displayAlert(title: "Error", message: "Number must not be empty")
        } else if (email == "") {
            self.displayAlert(title: "Error", message: "Email must not be empty")
        } else if (password == "") {
            self.displayAlert(title: "Error", message: "Password must not be empty")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        /* PART 1C START*/
        let resultVC = segue.destination as! FeedVC
        resultVC.userID = ourUserID
        /* PART 1C FINISH*/
    }
}
